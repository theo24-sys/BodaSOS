...
urlpatterns = [
    ...
    path("api/dashboard/active-emergencies/", views.dashboard_active_emergencies, name="dashboard_active_emergencies"),
    path("api/dashboard/riders/", views.dashboard_riders, name="dashboard_riders"),
